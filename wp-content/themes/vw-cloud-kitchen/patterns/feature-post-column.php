 ...
 * Slug: vw-cloud-kitchen/feature-post-column
 * Categories: template
 */
?>
			...
			>
				...
				>
					...
					<h3
						...
						"
					>
					<?php echo esc_html__( 'Popular News', 'vw-cloud-kitchen' ); ?>
					</h3>
					<!-- /wp:heading -->
				</div>
				<!-- /wp:group -->
			...
			>
				...
				>
					...
					<h3
						...
						"
					>
					<?php echo esc_html__( 'Recent News', 'vw-cloud-kitchen' ); ?>
					</h3>
					<!-- /wp:heading -->
				</div>
				<!-- /wp:group -->
