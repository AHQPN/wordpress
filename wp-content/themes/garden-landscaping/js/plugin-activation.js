jQuery(document).ready(function($) {
    'use strict';
    var this_obj = garden_landscaping_plugin_activate_plugin;


    $(document).on('click', '.garden-landscaping-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message garden-landscaping-plugin-install');
                button.addClass('button-primary garden-landscaping-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.garden-landscaping-recommended-plugins .garden-landscaping-activation-note').css('display','block');
    ...
    $(document).on('click', '.garden-landscaping-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .garden-landscaping-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .garden-landscaping-recommended-plugins').css('display','none');
    });
