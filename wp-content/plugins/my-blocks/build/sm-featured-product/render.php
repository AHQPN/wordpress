...
$section_title  = ! empty( $attributes['sectionTitle'] ) ? $attributes['sectionTitle'] : __( 'Featured Products', 'my-blocks' );
	...
	<div class="sm-fp-inner sm-slider-container">
		...
		<div class="sm-slider-track-wrap">
			<div class="sm-fp-track sm-slider-track">
				...
				?>
					<a class="sm-item-card sm-fp-item sm-slider-item" href="<?php echo esc_url( $permalink ); ?>">
