/******/ (() => { // webpackBootstrap
/*!****************************************!*\
  !*** ./src/sm-product-listing/view.ts ***!
  \****************************************/
/**
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  const updateFilters = () => {
    ...
    // Handle Stock Status
    const inStock = listingContainer.querySelector('#instock-listing');
    const outOfStock = listingContainer.querySelector('#outofstock-listing');
  ...
  headers.forEach(header => {
    header.addEventListener('click', () => {
      ...
      const content = group?.querySelector('.sm-filter-content');
      const icon = header.querySelector('.sm-toggle-icon');
