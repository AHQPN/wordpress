...
<section <?php echo $wrapper_attributes; ?>>
	<div class="sm-fp-inner">
		...
		<div class="sm-fp-track-wrap">
			<div class="sm-fp-track">
				...
				?>
				<a class="sm-fp-card" href="<?php echo esc_url( $permalink ); ?>">
					<div class="sm-fp-card-img">
						<?php if ( $on_sale ) : ?>
							<span class="sm-fp-badge">New Arrival</span>
						<?php endif; ?>
						<img src="<?php echo esc_url( $image_url ); ?>" alt="<?php echo esc_attr( $name ); ?>" loading="lazy" />
					</div>
					<h3 class="sm-fp-card-name"><?php echo esc_html( $name ); ?></h3>
					<div class="sm-fp-card-price"><?php echo $price_html; ?></div>
				</a>
				<?php endforeach; ?>
			</div>
		</div>
